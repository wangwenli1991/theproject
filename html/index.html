...
#email_templates .btn-vivid-red:focus { background-color: #b42424; color: #fff; border-color: #b42424; }
	...
	<body class="no-trans front-page">
		...
		<div class="page-wrapper">
												...
												<ul class="nav navbar-nav ">
																		...
																		<div class="row">
																			<div class="col-sm-6 col-md-3">
																				...
																				<ul class="menu">
																					...
																					<li ><a href="template/index-rtl.html"><i class="icon-home pr-10"></i>Home Default - RTL <span class="badge">New</span></a></li>
																					...
																					<li ><a href="template/index-corporate-4.html"><i class="icon-suitcase pr-10"></i>Corporate 4 <span class="badge">v1.2</span></a></li>
																					<li ><a href="template/index-corporate-5.html"><i class="icon-suitcase pr-10"></i>Corporate 5 (Law Firm) <span class="badge">v1.3</span></a></li>
																			...
																			<div class="col-sm-6 col-md-3">
																				...
																				<ul class="menu">
																					...
																					<li ><a href="template/index-portfolio-2.html"><i class="icon-camera pr-10"></i>Portfolio 2 <span class="badge">New</span></a></li>
																					...
																					<li ><a href="template/index-restaurant-2.html"><i class="fa fa-cutlery pr-10"></i>Restaurant 2 <span class="badge">v1.3</span></a></li>
																			...
																			<div class="col-sm-6 col-md-3">
																				<div class="divider"></div>
																				<ul class="menu">
																					<li ><a href="template/index-landing-2.html"><i class="fa fa-star pr-10"></i>Landing Page 2 <span class="badge">v1.3</span></a></li>
																					...
																					<li ><a href="template/index-construction.html"><i class="fa fa-building pr-10"></i>Construction <span class="badge">v1.1</span></a></li>
																					<li ><a href="template/index-education.html"><i class="fa fa-graduation-cap pr-10"></i>Education <span class="badge">v1.1</span></a></li>
																					<li ><a href="template/index-hotel.html"><i class="fa fa-bed pr-10"></i>Hotel <span class="badge">v1.1</span></a></li>
																					<li ><a href="template/index-blog.html"><i class="fa fa-pencil pr-10"></i>Blog <span class="badge">v1.1</span></a></li>
																					<li ><a href="template/index-blog-2.html"><i class="fa fa-pencil pr-10"></i>Blog 2<span class="badge">v1.3</span></a></li>
																				</ul>
																			</div>
																			<div class="col-sm-6 col-md-3">
																				<div class="divider"></div>
																				<ul class="menu">
																					<li ><a href="template/index-beauty.html"><i class="fa fa-magic pr-10"></i>Beauty Center <span class="badge">v1.1</span></a></li>
																					<li ><a href="template/index-gym.html"><i class="fa fa-heartbeat pr-10"></i>Gym <span class="badge">v1.2</span></a></li>
																					<li ><a href="template/index-resume.html"><i class="fa fa-user pr-10"></i>Resume <span class="badge">v1.2</span></a></li>
																					<li ><a href="template/index-agency.html"><i class="fa fa-users pr-10"></i>Agency <span class="badge">v1.2</span></a></li>
																					<li ><a href="template/index-logistics.html"><i class="fa fa-truck pr-10"></i>Logistics <span class="badge">v1.2</span></a></li>
																				</ul>
																			</div>
																		</div>
																	</div>
														...
														<ul class="dropdown-menu">
															<li class="dropdown ">
																...
																<ul class="dropdown-menu">
																	...
																	<li ><a href="template/features-headers-gradient-dark.html">Gradient Dark <span class="badge">v1.2</span></a></li>
																	<li ><a href="template/features-headers-gradient-light.html">Gradient Light <span class="badge">v1.2</span></a></li>
															...
															<li class="dropdown ">
																...
																<ul class="dropdown-menu">
																	<li ><a href="template/features-headers-default.html">Default</a></li>
																	<li ><a href="template/features-headers-sticky-2.html">Alternative <span class="badge">v1.2</span></a></li>
																</ul>
															</li>
															<li class="dropdown ">
															...
															<li class="dropdown ">
																...
																<ul class="dropdown-menu">
																	<li ><a href="template/features-footers-default.html#footer">Default</a></li>
																	<li ><a href="template/features-footers-contact-form.html#footer">Contact Form</a></li>
																	<li ><a href="template/features-footers-contact-form-2.html#footer">Contact Form 2 <span class="badge">v1.2</span></a></li>
																	<li ><a href="template/features-footers-google-maps.html#footer">Google Maps</a></li>
																	<li ><a href="template/features-footers-subscribe.html#footer">Subscribe Form</a></li>
																	<li ><a href="template/features-footers-minimal.html#footer">Minimal</a></li>
																	<li ><a href="template/features-footers-links.html#footer">Links <span class="badge">v1.1</span></a></li>
																	<li ><a href="template/features-footers-full-width.html#footer">Full Width <span class="badge">v1.2</span></a></li>
																</ul>
															</li>
															<li class="dropdown ">
																		...
																		<div class="row">
																			<div class="col-sm-6">
																				...
																				<ul class="menu">
																					...
																					<li ><a href="template/components-page-loaders.html"><i class="fa fa-circle-o-notch fa-spin"></i>Page Loaders <span class="badge">v1.1</span></a></li>
																			...
																			<div class="col-sm-6">
																				...
																				<ul class="menu">
																					...
																					<li ><a href="template/components-announcement-default.html"><i class="icon-megaphone pr-10"></i>Announcements <span class="badge">v1.3</span></a></li>
																					<li ><a href="template/components-separators.html"><i class="icon-star pr-10"></i>Separators <span class="badge">v1.3</span></a></li>
																				</ul>
																			</div>
																		</div>
																	</div>
													...
													<li class="dropdown ">
														...
														<ul class="dropdown-menu">
															...
															<li ><a href="template/shop-product.html">Product Page</a></li>
															<li ><a href="template/shop-product-2.html">Product Page 2 <span class="badge">v1.3</span></a></li>
													...
													<li class="dropdown ">
														...
														<ul class="dropdown-menu">
															<li ><a href="template/index-blog.html">Blog Home <span class="badge">v1.1</span></a></li>
															<li ><a href="template/index-blog-2.html">Blog Home 2 <span class="badge">v1.3</span></a></li>
															<li class="dropdown ">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 text-center col-md-offset-2 space-bottom">
							...
							<p class="text-center lead object-non-visible" data-animation-effect="fadeIn" data-effect-delay="100">Multipurpose HTML5 Template - More than 200+ HTML files.</p>
							...
							<ul class="list-inline">
								...
								<li class="object-non-visible" data-animation-effect="fadeIn" data-effect-delay="100"><i class="icon-check text-default"></i> Landing</li>
								<li class="object-non-visible" data-animation-effect="fadeIn" data-effect-delay="200"><i class="icon-check text-default"></i> One Page</li>
								<li class="object-non-visible" data-animation-effect="fadeIn" data-effect-delay="300"><i class="icon-check text-default"></i> Coming Soon</li>
								...
								<li class="object-non-visible" data-animation-effect="fadeIn" data-effect-delay="500"><i class="icon-check text-default"></i> Beauty Center</li>
								<li class="object-non-visible" data-animation-effect="fadeIn" data-effect-delay="600"><i class="icon-check text-default"></i> Construction</li>
								<li class="object-non-visible" data-animation-effect="fadeIn" data-effect-delay="100"><i class="icon-check text-default"></i> Hotel</li>
								<li class="object-non-visible" data-animation-effect="fadeIn" data-effect-delay="200"><i class="icon-check text-default"></i> Blog</li>
								<li class="object-non-visible" data-animation-effect="fadeIn" data-effect-delay="300"><i class="icon-check text-default"></i> Gym</li>
								<li class="object-non-visible" data-animation-effect="fadeIn" data-effect-delay="400"><i class="icon-check text-default"></i> Resume</li>
								<li class="object-non-visible" data-animation-effect="fadeIn" data-effect-delay="500"><i class="icon-check text-default"></i> Logistics</li>
								<li class="object-non-visible" data-animation-effect="fadeIn" data-effect-delay="600"><i class="icon-check text-default"></i> 14+ Header Options</li>
								<li class="object-non-visible" data-animation-effect="fadeIn" data-effect-delay="100"><i class="icon-check text-default"></i> 8+ Footer Options</li>
								...
								<li class="object-non-visible" data-animation-effect="fadeIn" data-effect-delay="300"><i class="icon-check text-default"></i> Much More</li>
							</ul>
						</div>
					</div>
					<div class="row">
			...
			<section class="pv-40">
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="col-sm-3">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">NEW</span> Default - RTL</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="intro-images/demo-38.jpg" alt="">
									<a target="_blank" href="template/index-rtl.html" class="overlay-link"><i class="fa fa-link"></i></a>
								</div>
							</div>
						</div>
						<div class="col-sm-3">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">NEW</span> Portfolio 2</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="intro-images/demo-39.jpg" alt="">
									<a target="_blank" href="template/index-portfolio-2.html" class="overlay-link"><i class="fa fa-link"></i></a>
								</div>
							</div>
						</div>
						<div class="col-sm-3">
					...
					<div class="row">
						...
						<div class="col-sm-3">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v1.2</span>Corporate 4</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="intro-images/demo-30.jpg" alt="">
									<a target="_blank" href="template/index-corporate-4.html" class="overlay-link"><i class="fa fa-link"></i></a>
								</div>
							</div>
						</div>
						<div class="col-sm-3">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v1.3</span>Corporate 5 (Law Firm)</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="intro-images/demo-34.jpg" alt="">
									<a target="_blank" href="template/index-corporate-5.html" class="overlay-link"><i class="fa fa-link"></i></a>
								</div>
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-sm-3">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v1.2</span>Agency</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="intro-images/demo-32.jpg" alt="">
									<a target="_blank" href="template/index-agency.html" class="overlay-link"><i class="fa fa-link"></i></a>
								</div>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-3">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v1.2</span>Gym</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="intro-images/demo-29.jpg" alt="">
									<a target="_blank" href="template/index-gym.html" class="overlay-link"><i class="fa fa-link"></i></a>
								</div>
							</div>
						</div>
						<div class="col-sm-3">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v1.2</span>Logistics</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="intro-images/demo-33.jpg" alt="">
									<a target="_blank" href="template/index-logistics.html" class="overlay-link"><i class="fa fa-link"></i></a>
								</div>
							</div>
						</div>
						<div class="col-sm-3">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v1.2</span>Resume</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="intro-images/demo-31.jpg" alt="">
									<a target="_blank" href="template/index-resume.html" class="overlay-link"><i class="fa fa-link"></i></a>
								</div>
							</div>
						</div>
						<div class="col-sm-3">
					...
					<div class="row">
						...
						<div class="col-sm-3">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v1.3</span>Restaurant 2</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="intro-images/demo-35.jpg" alt="">
									<a target="_blank" href="template/index-restaurant-2.html" class="overlay-link"><i class="fa fa-link"></i></a>
								</div>
							</div>
						</div>
						<div class="col-sm-3">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v1.1</span>Construction</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
						...
						<div class="col-sm-3">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v1.1</span>Education</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
					...
					<div class="row">
						<div class="col-sm-3">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v1.1</span>Hotel</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
						...
						<div class="col-sm-3">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v1.1</span>Blog</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
						...
						<div class="col-sm-3">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v1.3</span>Blog 2</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="intro-images/demo-36.jpg" alt="">
									<a target="_blank" href="template/index-blog-2.html" class="overlay-link"><i class="fa fa-link"></i></a>
								</div>
							</div>
						</div>
						<div class="col-sm-3">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v1.1</span>Beauty Center</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
					...
					<div class="row">
						...
						<div class="col-sm-3">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v1.3</span>Landing Page 2</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
									<img src="intro-images/demo-37.jpg" alt="">
									<a target="_blank" href="template/index-landing-2.html" class="overlay-link"><i class="fa fa-link"></i></a>
								</div>
							</div>
						</div>
						<div class="col-sm-3">
			...
			<section id="email_templates" class="pv-40">
				<div class="container-fluid">
					<h3 class="text-center"><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v1.1</span>HTML email templates</h3>
					<div class="row">
